 ...
 */
public class PeticionHabilidad implements Serializable {
    ...
    public PeticionHabilidad() {
        // Nada
    }

    // 6.2 Constructor para Read_All o PING
    public PeticionHabilidad(TipoOperacion tipoOperacion) {
        this.tipoOperacion = tipoOperacion;
    }

    // 6.3 Constructor para Read o Delete
    public PeticionHabilidad(TipoOperacion tipoOperacion, int idHabilidad) {
        this.tipoOperacion = tipoOperacion;
        this.idHabilidad = idHabilidad;
    }

    // 6.4 Constructor para Create/Update
    public PeticionHabilidad(TipoOperacion tipoOperacion, Habilidad habilidad, int idHabilidad) {
        this.tipoOperacion = tipoOperacion;
        this.habilidad = habilidad; // Este puede sobrar según uso
        this.idHabilidad = idHabilidad;
    }
